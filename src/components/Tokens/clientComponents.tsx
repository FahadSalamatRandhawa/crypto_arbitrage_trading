...
const default_Token_Value:Type_INSERT_TokenType={name:"Ethereum",address:"1234456awdnabdsa",isActive:false,symbol:"ETH",currencyType:""}
...
export const TokenAddForm=({default_value}:{default_value?:Type_INSERT_TokenType})=>{
    ...
    return (
        <Form {...form} >
            <form  onSubmit={form.handleSubmit(AddTokenHandler)} className=" grid grid-cols-1 md:grid-cols-2 place-content-evenly justify-between gap-[10px] bg-lime-egg/30 p-3 ">
                ...
                <FormField control={form.control} name="isActive" render={({field})=>(
                    <FormItem className=" w-min flex flex-col justify-end justify-self-end" >
                ...
                <Button type="submit" >{default_value?"Update":"Add"}</Button>
            </form>
        </Form>
    )
}